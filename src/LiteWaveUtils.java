...
public abstract class LiteWaveUtils {
	...
	public static <U> List<Map<U, Double>> peakDetection(List<Double> values, Double delta, List<U> indices)
	{
		assert(indices != null);
	...
	public static List<Map<Integer, Double>> peakDetection(List<Double> values, Double delta)
	{
